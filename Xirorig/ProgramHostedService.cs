...
namespace Xirorig
{
    internal class ProgramHostedService : IHostedService, IDisposable
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($" {AnsiEscapeCodeConstants.GreenForegroundColor}*{AnsiEscapeCodeConstants.Reset} {{Category,-12:l}} {{Color:l}}{{VectorIsSupported}}{AnsiEscapeCodeConstants.Reset}", false, "NATIVE LIBS", Sha3Utility.IsNativeImplementationAvailable ? AnsiEscapeCodeConstants.GreenForegroundColor : AnsiEscapeCodeConstants.RedForegroundColor, Sha3Utility.IsNativeImplementationAvailable);
