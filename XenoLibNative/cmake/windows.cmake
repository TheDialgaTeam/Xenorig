...
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm")
   ...
   if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows" AND CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "x86_64")
      set(CMAKE_C_COMPILER_TARGET arm-win32-gnueabihf)
      set(CMAKE_CXX_COMPILER_TARGET arm-win32-gnueabihf)
   endif()
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
   set(CMAKE_SYSTEM_PROCESSOR aarch64 CACHE STRING "")
   if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows" AND CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "x86_64")
      set(CMAKE_C_COMPILER_TARGET aarch64-win32-gnu)
      set(CMAKE_CXX_COMPILER_TARGET aarch64-win32-gnu)
   endif()
endif()
